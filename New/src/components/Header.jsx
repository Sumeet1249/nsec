...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[120]">
      ...
      <div className="bg-brand-accent text-white h-12 flex items-center justify-between px-12 relative overflow-hidden">
      ...
      <header className="bg-white h-32 flex flex-col justify-center border-b border-brand-accent/10 shadow-lg relative overflow-hidden">
